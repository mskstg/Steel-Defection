...
def main():
    ...
    PATH = './weight_gpu_vgg19_resize_multi_weight_weight6.pth'

    weight = torch.tensor([0.3, 0.2, 0.2, 0.2, 0.2]).to(device)
    criterion = nn.CrossEntropyLoss(weight=weight)
    optimizer = optim.SGD(net.parameters(), lr=0.001, momentum=0.9, weight_decay=1e-03)
